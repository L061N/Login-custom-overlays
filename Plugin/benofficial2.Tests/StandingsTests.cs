...
namespace benofficial2.Tests
{
    ...
    public sealed class StandingsTests
    {
        ...
        public void EstimateTotalLaps_LapRace_EnoughTime()
        {
            ...
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ -1.0, /*sessionTotalLaps*/ 30, /*sessionTimeRemain*/ 3600.0, /*avgLapTime*/ 90.0);
            Assert.AreEqual(30, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 0.0, /*sessionTotalLaps*/ 30, /*sessionTimeRemain*/ 3600.0, /*avgLapTime*/ 90.0);
            Assert.AreEqual(30, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 15.0, /*sessionTotalLaps*/ 30, /*sessionTimeRemain*/ 3600.0, /*avgLapTime*/ 90.0);
            Assert.AreEqual(30, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 30.0, /*sessionTotalLaps*/ 30, /*sessionTimeRemain*/ 3600.0, /*avgLapTime*/ 90.0);
            Assert.AreEqual(30, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 31.0, /*sessionTotalLaps*/ 30, /*sessionTimeRemain*/ 3600.0, /*avgLapTime*/ 90.0);
            Assert.AreEqual(30, estimatedTotalLaps);
        }
        ...
        public void EstimateTotalLaps_TimeRace_ExtraLap_HitZeroFlush()
        {
            ...
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 0.0, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 900.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 8.7, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 117.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);
            ...
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 8.9, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 99.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 9.1, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 81.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 9.7, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 27.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            // Getting the white flag here because the timer will hit zero just as we cross the line.
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 9.9, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 9.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            // Should have had the white flag by now. Timer reached zero.
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 10.1, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 0.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 10.7, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 0.0, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);

            // Estimate keeps going up at this point as if we did not get the white flag.
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(/*currentLapHighPrecision*/ 10.9, /*sessionTotalLaps*/ 0, /*sessionTimeRemain*/ 0.0, avgLapTime);
        ...
        public void EstimateTotalLaps_TimeRace_NoExtraLap_HitZeroEarly()
        {
            ...
            estimatedTotalLaps = StandingsModule.EstimateTotalLaps(currentLapHighPrecision, sessionTotalLaps, sessionTimeRemain, avgLapTime);
            Assert.AreEqual(11, estimatedTotalLaps);
